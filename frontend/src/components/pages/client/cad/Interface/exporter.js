...
export function exportObject(object) {
	...
	let objString = exporter.parse(object);
	// Usage
	var blob = new Blob([objString], { type: "text/plain" }); // Generate Blob from the string
	saveAs(blob, "file.obj"); //Save the Blob to file.stl
}
